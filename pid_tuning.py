...
RIGHTMOTORPARAMS.pidParameters.k_i = 250.0
...
for test_val in TEST_PWM:
	#interface.startLogging("PID_log/KP_800_KD_TUNE_VAL%d.log" %(test_val))
	interface.startLogging(folder + "/KP_TUNE_PWM_%d.log" % (test_val))

	print "Now testing minPWM of %03d..." %(test_val)
	#print "Now testing k_d value of %3d" %(test_val)
	LEFTMOTORPARAMS.minPWM = test_val
	RIGHTMOTORPARAMS.minPWM = test_val
