...
#Imports, Globals, Global functions
###################################
import time
import random
import math
import helperFunctions as hf
import waypointnavigation as nav
...
def smartNav():
    ...
    while ind < len(all_waypoints):
        ...
        if (checkpoint[0]-bot_pos[0])**2 + (checkpoint[1]- bot_pos[1])**2 < 16:
            ind += 1
###################################
